...
static void kalray_coolidge_v2_sdhci_reset(struct sdhci_host *host, u8 mask)
{
	struct sdhci_pltfm_host *pltfm_host = sdhci_priv(host);
	struct dwcmshc_priv *priv = sdhci_pltfm_priv(pltfm_host);
...
static void kalray_coolidge_v2_sdhci_set_clock(struct sdhci_host *host, unsigned int clock)
{
	struct sdhci_pltfm_host *pltfm_host = sdhci_priv(host);
	struct dwcmshc_priv *priv = sdhci_pltfm_priv(pltfm_host);
	int reg = priv->vendor_specific_area1 + SDHCI_GPIO_OUT;
...
static const struct sdhci_ops kalray_coolidge_v2_sdhci_dwcmshc_ops = {
	.set_clock		= kalray_coolidge_v2_sdhci_set_clock,
	.set_bus_width		= sdhci_set_bus_width,
	.set_uhs_signaling	= dwcmshc_set_uhs_signaling,
	.get_max_clock		= dwcmshc_get_max_clock,
	.reset			= kalray_coolidge_v2_sdhci_reset,
	.adma_write_desc	= dwcmshc_adma_write_desc,
};
...
static const struct sdhci_pltfm_data sdhci_dwcmshc_kalray_coolidge_pdata = {
	.ops = &sdhci_dwcmshc_ops,
...
static const struct sdhci_pltfm_data sdhci_dwcmshc_kalray_coolidge_v2_pdata = {
	.ops = &kalray_coolidge_v2_sdhci_dwcmshc_ops,
	.quirks = SDHCI_QUIRK_CAP_CLOCK_BASE_BROKEN | SDHCI_QUIRK_BROKEN_TIMEOUT_VAL,
...
static const struct of_device_id sdhci_dwcmshc_dt_ids[] = {
	...
	{
		.compatible = "kalray,coolidge-dwcmshc-sdhci",
		.data = &sdhci_dwcmshc_kalray_coolidge_pdata,
	},
	{
		.compatible = "kalray,coolidge-v2-dwcmshc-sdhci",
		.data = &sdhci_dwcmshc_kalray_coolidge_v2_pdata,
	},
	{},
};
