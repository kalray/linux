...
{
	k1c_sfr_clear_bit(K1C_SFR_TCR, K1C_SFR_TCR_T0CE_SHIFT);
...
static int k1c_timer_starting_cpu(unsigned int cpu)
{
	...
	k1c_sfr_set_bit(K1C_SFR_TCR, K1C_SFR_TCR_T0IE_SHIFT);
...
TIMER_OF_DECLARE(k1c_core_timer, "kalray,k1c-core-timer",
...
TIMER_OF_DECLARE(k1c_dsu_clock, "kalray,k1c-dsu-clock",
						k1c_setup_dsu_clock);
